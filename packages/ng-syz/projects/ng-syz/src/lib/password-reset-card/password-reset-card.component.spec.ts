...
describe('NgSyzPasswordResetCardComponent', () => {
  let component: NgSyzPasswordResetCardComponent;
  let template: HTMLElement;
  let fixture: ComponentFixture<NgSyzPasswordResetCardComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NgSyzPasswordResetCardComponent);
