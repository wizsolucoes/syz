...
describe('NgSyzSimulationResultComponent', () => {
  ...
  let fixture: ComponentFixture<NgSyzSimulationResultComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NgSyzSimulationResultComponent);
  ...
  it('should display all condições com títulos e valores', () => {
    ...
    expect(titulos[0].textContent.trim()).toBe(component.condicoes[0].condicao);
    expect(titulos[1].textContent.trim()).toBe(component.condicoes[1].condicao);
    expect(titulos[2].textContent.trim()).toBe(component.condicoes[2].condicao);
    expect(valores[0].textContent.trim()).toBe(component.condicoes[0].valor);
    expect(valores[1].textContent.trim()).toBe(component.condicoes[1].valor);
    expect(valores[2].textContent.trim()).toBe(component.condicoes[2].valor);
  });
