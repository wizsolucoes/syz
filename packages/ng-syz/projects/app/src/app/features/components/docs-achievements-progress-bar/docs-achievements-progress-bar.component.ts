...
export class DocsAchievementsProgressBarComponent {
  ...
  componentProps: ComponentProps[] = [
    ...
    },
    {
      ...
      description:
        'Controle para facilitar de forma genérica se o elemento da esquerda no toggle está ativado.',
    },
  ];
  ...
  componentCSSVariables: ComponentProps[] = [
    ...
    },
    {
      ...
      description:
        'Cor utilizada de background da barra de progresso atual e toggle ativo',
    },
    {
    ...
    },
    {
      ...
      description:
        'Cor utilizada de background na barra de progresso do objetivo',
    },
    {
