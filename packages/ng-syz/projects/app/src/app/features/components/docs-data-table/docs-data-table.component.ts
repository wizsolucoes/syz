...
export class DocsDataTableComponent implements OnInit {
  ...
  codeExemple01 = {
    ...
    tableInfo = {
      tableDescription: 'Cadastro de empresas', // Description for accessibility
      header: [
        'Cadastro',
        'Contato da Empresa',
        'Nome da Empresa',
  ...
  Description =
    'Componente irá montar uma tabela podendo ser paginada utilizando paginação com ou sem serviço! \n\n';
