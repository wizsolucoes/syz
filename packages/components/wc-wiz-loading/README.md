...
```html
  ...
  <wiz-loading type="spinner-percent" percentage="50" ></wiz-loading>
  <wiz-loading type="spinner-continuous" ></wiz-loading>
  <wiz-loading type="feedback-sonar" ></wiz-loading>
  <wiz-loading type="feedback-bounce" ></wiz-loading>
  <wiz-loading type="loading-z" ></wiz-loading>
  <wiz-loading type="circle-load-check" finish="{{variable}}" ></wiz-loading>
...
|-------------------|-------------|----------|------|---|
| type    		| Não	| string	| null	|  Todos os types foram apresentados no exemplo.
| percentage    		| Não	| string	| null	|  Específico para o type spinner-percent. Referente ao progresso. 
| finish    		| Não	| boolean	| null	|  Específico para o type circle-load-check mostrar o icon assim que for concluído o carregamento.
