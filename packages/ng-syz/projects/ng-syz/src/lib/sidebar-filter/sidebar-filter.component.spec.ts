...
describe('FiltroComponent', () => {
  let component: NgSyzSideBarFilterComponent;
  let fixture: ComponentFixture<NgSyzSideBarFilterComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NgSyzSideBarFilterComponent);
