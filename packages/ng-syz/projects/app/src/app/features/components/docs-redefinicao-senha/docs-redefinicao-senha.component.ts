...
@Component({
  selector: 'app-docs-redefinicao-senha',
  templateUrl: './docs-redefinicao-senha.component.html',
  styleUrls: ['./docs-redefinicao-senha.component.scss'],
})
export class DocsRedefinicaoSenhaComponent implements OnInit {
  importCode =
